...
os.environ['IG_USERNAME'] = 'theclosetinc' # Set IG_USERNAME to username account you want to monitor. Example - ladygaga
os.environ['WEBHOOK_URL'] = 'https://discordapp.com/api/webhooks/819655284204634163/WtTqZrvp6XGbPVllWE8ZWJRYERCVIfREpWzr0BY3AaJ7rGTnjCSsjcS7Ng4RosKsbx3l' # Set WEBHOOK_URL to Discord account webhook url. To know how, just Google: "how to create webhook discord".
os.environ['TIME_INTERVAL'] = '30' # Set TIME_INTERVAL to the time in seconds in between each check for a new post. Example - 1.5, 600 (default=600)
...
def webhook(webhook_url, html):
    ...
    embed["title"] = "New post by @"+INSTAGRAM_USERNAME+""
